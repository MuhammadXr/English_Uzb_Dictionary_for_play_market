package uz.gita.english_uzbdictionary_for_play_market.ui.dialog
...
class UzbWordInfoDialog : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (data.isUzbFavourite == 0) {
            btnStart.setImageResource(R.drawable.ic_baseline_star_border_24)
        } else {
            btnStart.setImageResource(R.drawable.ic_baseline_star_24)
        }
        btnStart.setOnClickListener {
            if (data.isUzbFavourite == 1) {
                btnStart.setImageResource(R.drawable.ic_baseline_star_border_24)
            } else {
                btnStart.setImageResource(R.drawable.ic_baseline_star_24)
            }
