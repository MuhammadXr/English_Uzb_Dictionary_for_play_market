...
import uz.gita.english_uzbdictionary_for_play_market.presenter.FavUzbViewModel
...
class FavoritesUzb : Fragment(R.layout.fragment_favorites) {
    lateinit var list : RecyclerView
    lateinit var adapter : WordAdapterUzb
    lateinit var searchView: SearchView
    lateinit var handler: Handler

    val viewModel : FavUzbViewModel by viewModels ()
